...
<body>
     <div class="container">
      ...
      <form class="form-signin" method="post">
        <h2 class="form-signin-heading">Signup</h2> Already an user? <a href="/login">Please Login</a></p>
        <input type="text" name="username" class="input-block-level" placeholder="Username" value="${username}" > 
        <p class="error"> ${username_error!""} </p>
        <input type="password" name="password" class="input-block-level" placeholder="Password" value="">
        <p class="error">
	    ${password_error!""}
        </p>
         <input type="password" name="verify" class="input-block-level" placeholder="Verify Password" value="">
         <p class="error">
	    ${verify_error!""}
        </p>
         <input type="text" name="email" class="input-block-level" placeholder="Email(Optional)" value="${email}" > 
         <p class="error">
	    ${email_error!""}
        </p>
